...
public class LoanContractServiceImpl implements LoanContractService {
    ...
    public List<Contract> getAllContracts() {
        return loanContractDao.getAllContracts();
    }

    @Override
    @Transactional(readOnly = true)
    public Contract getContractById(String contractId) {
        return loanContractDao.getContractById(contractId);
    }
    ...
    public List<Contract> getContractByBorrower(long customerId) {
        return loanContractDao.getContractByBorrower(customerId);
    }
    ...
    public LoanContractResponse createLoanContractResponse(Contract contract) {
        ...
        if (contract != null) {
            ...
            if (borrower != null) {
                ...
                com.westbank.db.entity.Address borrowerAddress = borrower.getAddress();
