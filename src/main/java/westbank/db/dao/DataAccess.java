...
public class DataAccess extends HibernateDaoSupport {
    ...
    protected LoanContractResponse createLoanContractResponse(Contract contract) {
        ...
        if (contract != null) {
            ...
            if (borrower != null) {
                ...
                final westbank.ws.business.loancontract._2009._11.Address responseBorrowerAddress = new westbank.ws.business.loancontract._2009._11.Address();
            ...
            if (agency != null) {
                ...
                final westbank.ws.business.loancontract._2009._11.Address agencyAddress = new westbank.ws.business.loancontract._2009._11.Address();
            ...
            if (borrower != null) {
                ...
                if (loanFile != null) {
                    ...
                    try {
                        ...
                        if (borrower != null & borrower.getCustomerId() != null) {
                ...
                log.error("Cannot create a new loan file without a borrower");
            }
        }
        return response;
    }
    ...
    public LoanFile getLoanFileById(String loanFileId) {
        ...
        if (loanFileId != null) {
            result = (LoanFile) getHibernateTemplate().get(LoanFile.class, loanFileId);
        }
        return result;
    }
    ...
    public Contract getContractById(String contractId) {
        if (contractId != null) {
            return (Contract) getHibernateTemplate().get(Contract.class, contractId);
        }
        return null;
    }
     ...
     *
     * @param customer -- the {@link Contract} object to be stored
     */
     ...
     * @param pin     -- the staff's password
