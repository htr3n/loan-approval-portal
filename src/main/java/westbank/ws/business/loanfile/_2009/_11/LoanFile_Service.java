 ...
 * 2018-06-19T08:30:31.986+10:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "LoanFile",
                  targetNamespace = "urn:westbank:ws:business:LoanFile:2009:11")
public class LoanFile_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("urn:westbank:ws:business:LoanFile:2009:11", "LoanFile");
    public final static QName LoanFilePort = new QName("urn:westbank:ws:business:LoanFile:2009:11", "LoanFilePort");
    static {
        WSDL_LOCATION = null;
    }
