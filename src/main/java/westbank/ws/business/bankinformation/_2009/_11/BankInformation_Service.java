 ...
 * 2018-06-19T08:30:32.178+10:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "BankInformation",
                  targetNamespace = "urn:westbank:ws:business:BankInformation:2009:11")
public class BankInformation_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("urn:westbank:ws:business:BankInformation:2009:11", "BankInformation");
    public final static QName BankInformationPort = new QName("urn:westbank:ws:business:BankInformation:2009:11", "BankInformationPort");
    static {
        WSDL_LOCATION = null;
    }
