 ...
 * 2018-06-16T23:03:40.059+10:00
 * Generated source version: 3.2.4
 *
 */
@WebServiceClient(name = "CallbackLoanContract",
                  targetNamespace = "urn:westbank:ws:client:CallbackLoanContract")
public class CallbackLoanContract_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("urn:westbank:ws:client:CallbackLoanContract", "CallbackLoanContract");
    public final static QName CallbackLoanContractPort = new QName("urn:westbank:ws:client:CallbackLoanContract", "CallbackLoanContractPort");
    static {
        WSDL_LOCATION = null;
    }
