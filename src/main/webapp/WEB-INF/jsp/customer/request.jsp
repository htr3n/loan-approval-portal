	    ...
	    <fieldset id="pt6">
	        ...
	        <h3>Access Sensitive Data</h3>
	        	...
	        	<label for="accessSensitiveData">Give Access to sensitive data?
         	 	<form:checkbox id="accessSensitiveData" path="accessSensitiveData" onclick="toggleAccessSensitiveData()" tabindex="60" />
	      ...
	      <fieldset id="last">
           <div id=divsubmit>
              <div class="buttons">
                 ...
                 <a class="negative" onclick="$('#applform')[0].reset();"><img src="images/reset.png" alt=""/>Reset</a>
              </div>  
           </div>
	        <div id="disclaimer">By clicking the &#8220;Submit&#8221; button,
	          I am attaching my personal information and agreeing to WestBank's
                ...
                privacy statements, I should refrain from using services provided by WestBank.</div>
	      </fieldset>
    </div>
  </form:form>
</body>
