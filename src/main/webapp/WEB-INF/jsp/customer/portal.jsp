	        ...
	        <tbody>
	          <c:forEach items="${loans}" var="loan" varStatus="loopVar">
                ...
                <td title="${loan.estateLocation}">${loan.estateType}</td>
	              <td>
	                <fmt:formatNumber value='${loan.totalPurchasePrice}' type="currency" groupingUsed="true" maxFractionDigits="0"/>
	              </td>
                <td>
                ...
                <td>
                  <fmt:formatNumber value='${loan.contract.monthlyPayment}' type="currency" groupingUsed="true" maxFractionDigits="0"/>
                </td>
                ...
                <td style="width:150px!important;">
                  <c:choose>
                   <c:when test="${loan.contract.signedByManager != null 
                       ...
                       <div class="buttons">
                         <a class="positive" onclick="doSubmit('sign','${loan.loanFileId}', '${loan.contract.contractId}');">
                         <img src="images/sign.png" alt="" />Sign</a>
                         <a class="negative" onclick="doSubmit('cancel','${loan.loanFileId}', '${loan.contract.contractId}');">
